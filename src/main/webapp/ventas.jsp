    ...
    <body>
        <div class="container">
            ...
            <jsp:include page="WEB-INF/menu.jsp">
                <jsp:param name ="opcion" value="VentaControlador" />
            </jsp:include>
            ...
            <table <table class="table table-striped"> 
                ...
                <td><a href="VentaControlador?action=delete&id=${item.id}" onclick ="return(confirm('Esta seguro de eliminar el registro??'))">
